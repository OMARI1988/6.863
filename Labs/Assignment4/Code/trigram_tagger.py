...
if __name__ == "__main__":
  ...
  initial_tags = (None, None)
  
  for ngram in hmm.ngram_counts[2]:
    if ngram[0] == "*":
      initial_probability[(ngram[1], ngram[2])] = trigram_probability("*", ngram[1], ngram[2], hmm)
      tag_pairs.add((ngram[1], ngram[2]))
  
  
  initial_tags = arg_max(tag_pairs, lambda tags: trigram_probability("*", tags[0], tags[1], hmm))[0]
